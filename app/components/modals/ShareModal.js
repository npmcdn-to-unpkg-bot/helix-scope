      ...
      <div>
        <Modal
          ...
          <div className="share-links">
            <a href={`http://www.facebook.com/sharer/sharer.php?u=http://helixscope.org${this.props.shareUrl}`} className="c-btn btn-link" target="_blank">
              <svg className={`btn-icon icon-facebook -none -size-small`}>
                <use xlinkHref={`#icon-facebook`}></use>
              </svg>
            </a>
            <a href={`https://twitter.com/share?url=http://helixscope.org${this.props.shareUrl}`} className="c-btn btn-link" target="_blank">
